    ...
    return {
        ...
        execute: function() {
            ViewBeerComponent = (function () {
                ...
                ], ViewBeerComponent.prototype, "beer", void 0);
                ViewBeerComponent = __decorate([
                    core_1.Component({
                        selector: 'view-beer',
                        templateUrl: 'views/Components/view-beer.html',
                    }), 
                    __metadata('design:paramtypes', [beer_service_1.BeerService, router_1.Router])
                ], ViewBeerComponent);
                return ViewBeerComponent;
            }());
            exports_1("ViewBeerComponent", ViewBeerComponent);
        }
    }
});
