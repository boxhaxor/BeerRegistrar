...
var beer_1 = require('../DomainObjects/beer');
var BeerService = (function () {
    ...
    BeerService.prototype.addBeer = function (name, style, comments, specialIngredients, recipe) {
        ...
        recipe = recipe.trim();
        if (name) {
            var beer = new beer_1.Beer(BeerService.nextCrisisId++, name, style, comments, specialIngredients, recipe);
            beersPromise.then(function (beers) { return beers.push(beer); });
        }
    };
